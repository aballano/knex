...
open class ViewKnexRenderer<in Content : Any, out View : android.view.View>(
        ...
        private val renderFunction: (Content, View) -> Unit) : KnexRenderer<Content>() {

    override fun inflate(inflater: LayoutInflater, parent: ViewGroup): View = initFunction(parent.context)
    @Suppress("UNCHECKED_CAST") override fun render(content: Content, position: Int, payloads: List<*>) =
